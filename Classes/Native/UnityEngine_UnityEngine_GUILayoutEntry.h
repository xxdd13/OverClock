...
struct  GUILayoutEntry_t6_190  : public Object_t
{
	...
	GUIStyle_t6_28 * ___m_Style_7;
};
struct GUILayoutEntry_t6_190_StaticFields{
	// UnityEngine.Rect UnityEngine.GUILayoutEntry::kDummyRect
	Rect_t6_47  ___kDummyRect_8;
