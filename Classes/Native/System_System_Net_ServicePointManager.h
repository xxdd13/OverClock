...
struct  ServicePointManager_t2_39  : public Object_t
{
};
struct ServicePointManager_t2_39_StaticFields{
	...
	RemoteCertificateValidationCallback_t2_28 * ___server_cert_cb_9;
};
